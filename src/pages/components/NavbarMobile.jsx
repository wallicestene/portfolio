...
const NavbarMobile = ({scrollToSkills, scrollToAbout, scrollToProjects, scrollToContact, setShowNavbarMobile}) => {
  ...
  return (
    <div>
        ...
        <ul className="flex flex-col gap-10 items-center font-SpaceGrotesk tracking-wide text-lg">
          ...
          <li className=' cursor-pointer'>
          <Link to="skills" smooth={true}onClick={() => {
            scrollToSkills,
            setShowNavbarMobile(false)
          }}  > Skills</Link>
          </li>
          <li className=' cursor-pointer'>
          <Link to="projects" smooth={true} onClick={() => {
            scrollToProjects,
            setShowNavbarMobile(false)
          }} > Projects</Link>
          </li>
          <li className=' cursor-pointer'>
            <Link to="contact" smooth={true} onClick={() => {
            scrollToContact,
            setShowNavbarMobile(false)
          }} >Contact</Link>
          </li>
